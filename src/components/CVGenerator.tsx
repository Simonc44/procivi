      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <Badge variant="outline" className="mb-4 bg-ai-purple/10 text-ai-purple border-ai-purple/20">
            <Brain className="w-4 h-4 mr-2" /> Générateur intelligent
          </Badge>
          <h2 className="text-4xl font-bold text-foreground mb-4">Crée ton CV en 3 étapes</h2>
              ...
              <CardHeader>
                <CardTitle className="flex items-center justify-between">
                  ...
                  <Badge variant="outline" className="bg-success/10 text-success border-success/20">
                    <CheckCircle className="w-3 h-3 mr-1" /> ATS Optimisé
                  </Badge>
                </CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-border/50">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <Download className="w-5 h-5" /> Options d'export
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid gap-3">
                  <Button variant="outline" className="justify-start" disabled>
                    <FileText className="w-4 h-4 mr-2" /> Télécharger en PDF
                  </Button>
                  <Button variant="outline" className="justify-start" disabled>
                    <Download className="w-4 h-4 mr-2" /> Exporter en PNG
                  </Button>
                  <Button variant="outline" className="justify-start" disabled>
                    <Mail className="w-4 h-4 mr-2" /> Générer une lettre de motivation
                  </Button>
                </div>
